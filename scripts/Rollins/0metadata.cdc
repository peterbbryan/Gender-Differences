@UTF8
Title:	English Rollins Corpus	
Creator:	Rollins, Pamela
...
Description:	The three .cha files illustrate the application of the INCA-R coding
scheme to the three large video files. Sentences are linked by bullets and 
Coder's editor was used to insert speech act codes.
Publisher:	TalkBank
Contributor:	
Date:		2004-03-31
Type:	Text
